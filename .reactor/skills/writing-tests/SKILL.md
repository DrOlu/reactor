---
name: Writing Tests
description: Comprehensive guide for writing unit tests, integration tests, and component tests in Reactor using Vitest. Use when creating new tests, configuring mocks, or organizing test files.
---
