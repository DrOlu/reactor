...
Reactor provides pre-configured mocks for Electron and internal APIs.
...
Reactor provides centralized mock factories for consistent testing across the codebase.
