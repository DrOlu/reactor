...
Detailed directory structure and naming conventions for Reactor.

## Directory Structure

Reactor uses a **colocated** test structure for components and local logic, and a **mirrored** structure for global services or shared utilities.
