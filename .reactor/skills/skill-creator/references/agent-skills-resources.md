...
- **Custom Skills**: Filesystem-based (`.reactor/skills/` or
  `~/.reactor/skills/`)
- **Sharing**: Via git/version control
- **Integration**: Skills are activated through the agent's skill activation system

**Note**: Skills are specific to Reactor's implementation and work through the built-in skill management system.
