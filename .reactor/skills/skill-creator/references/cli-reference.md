...
```bash
# Create skill with default location (.reactor/skills/)
...
```
✅ Skill created at: .reactor/skills/my-skill

Next steps:
1. Edit .reactor/skills/my-skill/SKILL.md with your skill instructions
2. Add detailed documentation to references/
3. Add executable scripts to scripts/
4. Remove example files you don't need

Validate with: claude-skills-cli validate .reactor/skills/my-skill
```
...
```bash
# Validate skill
npx claude-skills-cli validate .reactor/skills/my-skill

# Strict mode (warnings = errors)
npx claude-skills-cli validate .reactor/skills/my-skill --strict

# Validate multiple skills
npx claude-skills-cli validate .reactor/skills/skill-1
npx claude-skills-cli validate .reactor/skills/skill-2
```
...
npx claude-skills-cli doctor .reactor/skills/my-skill

# Common workflow after formatting
npx prettier --write .reactor/skills/my-skill/SKILL.md
npx claude-skills-cli doctor .reactor/skills/my-skill
npx claude-skills-cli validate .reactor/skills/my-skill
```
...
npx claude-skills-cli package .reactor/skills/my-skill

# Custom output directory
npx claude-skills-cli package .reactor/skills/my-skill --output builds/

# Skip validation (not recommended)
npx claude-skills-cli package .reactor/skills/my-skill --skip-validation
```
...
# 2. Edit SKILL.md
vim .reactor/skills/database-queries/SKILL.md

# 3. Add references
vim .reactor/skills/database-queries/references/schema.md

# 4. Format (if using formatter)
npx prettier --write .reactor/skills/database-queries/SKILL.md

# 5. Fix any formatting issues
npx claude-skills-cli doctor .reactor/skills/database-queries

# 6. Validate
npx claude-skills-cli validate .reactor/skills/database-queries

# 7. Fix any remaining issues, re-validate
npx claude-skills-cli validate .reactor/skills/database-queries

# 8. Package
npx claude-skills-cli package .reactor/skills/database-queries
```
...
{
  "scripts": {
    "test:skills": "claude-skills-cli validate .reactor/skills/* --strict"
  }
}
...
for skill in .reactor/skills/*/; do
...
```json
{
	"scripts": {
		...
		"skill:validate": "claude-skills-cli validate .reactor/skills/*",
		"skill:validate:strict": "claude-skills-cli validate .reactor/skills/* --strict",
		"skill:package": "claude-skills-cli package",
...
- [Anthropic Skills Documentation](https://docs.reactor.com/en/docs/agents-and-tools/agent-skills/overview)
