...
When you run `/init`, Reactor performs an analysis of your project's directory. It identifies key aspects like:
...
This file is different from the `AGENTS.md` located in the root of the Reactor application repository, which contains guidelines for Reactor's own development. The one generated by `/init` is tailored *to your project* and is intended to be used by the agent during your work tasks.
...
You can find an example of the `AGENTS.md` file generated for Reactor itself [here](https://github.com/DrOlu/reactor/blob/main/.reactor/rules/AGENTS.md).
