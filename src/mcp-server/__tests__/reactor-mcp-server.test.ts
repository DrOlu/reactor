...
import { server } from '../reactor-mcp-server';

vi.mock('axios');

describe('Reactor MCP Server', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('should be initialized with correct metadata', () => {
    ...
    expect(serverInfo.name).toBe('reactor-mcp-server');
  ...
  it('should call Reactor API when add_context_file is executed', async () => {
  ...
  it('should call Reactor API when drop_context_file is executed', async () => {
    const mockResponse = { data: { success: true } };
    vi.mocked(axios.post).mockResolvedValueOnce(mockResponse);
  ...
  it('should call Reactor API when get_context_files is executed', async () => {
  ...
  it('should call Reactor API when get_addable_files is executed', async () => {
  ...
  it('should call Reactor API when run_prompt is executed', async () => {
  ...
  it('should call Reactor API when clear_context is executed', async () => {
    const mockResponse = { data: { success: true } };
    vi.mocked(axios.post).mockResolvedValueOnce(mockResponse);
